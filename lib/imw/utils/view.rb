...
class IMW < OpenStruct
  ...
  #   - field:        (...)
  #     
  # * Objects are referred to by __uniqname__, *NOT* __id__. If an ID is
  #   included, and an object exists with a non-matching ID or uniqname,
  ...
  #   can either refer to (via uniqname) a field defined elsewhere, or you can
  ...
  #   uniqname.  If there's an existing object, any new information (fields with
